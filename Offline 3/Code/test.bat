...
gcc -c -o %1.o %1.cpp -I\"D:\CodeBlocks\MinGW\x86_64-w64-mingw32\include"
@REM cls
@REM echo "Compiling Graphic"
@REM gcc -o %1.exe  %1.o -L\"D:\CodeBlocks\MinGW\x86_64-w64-mingw32\lib -lopengl32 -lglu32 -lfreeglut"
cls
echo "App Running"
%1.exe