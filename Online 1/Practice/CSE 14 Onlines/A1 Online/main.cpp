...
void display(){
	...
	****************************/
	...
	{
		glColor3f(0,0,1);
		glTranslatef(-SQ_L,0,0);
		glRotatef(ROT_B,0,1,0);
		glTranslatef(SQ_L,0,0);

		glTranslatef(-2*SQ_L,0,0);
    	drawSquare(SQ_L);
	}
	glPopMatrix();
	...
	glPushMatrix();
	{
		...
		glTranslatef(3*SQ_L,0,0);
		glRotatef(ROT_SKY,0,1,0);
		glTranslatef(-3*SQ_L,0,0);

		glTranslatef(4*SQ_L,0,0);
    	drawSquare(SQ_L);
	}
	glPopMatrix();
