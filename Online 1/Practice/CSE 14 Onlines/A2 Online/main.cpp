...
void display(){
	...
	****************************/
	...
	int hexR = 10;
	double intAng = 60*acos(-1)/180; // 60 degree to radian
	...
	PT p1 = PT(hexR,0,0);
	PT p2 = PT(-hexR,0,0);
	PT p3 = PT(hexR*cos(intAng),hexR*sin(intAng),0);
	PT p4 = PT(hexR*cos(intAng),-hexR*sin(intAng),0);
	PT p5 = PT(-hexR*cos(intAng),hexR*sin(intAng),0);
	PT p6 = PT(-hexR*cos(intAng),-hexR*sin(intAng),0);
