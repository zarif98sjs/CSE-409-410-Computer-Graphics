...
void drawTriange(PT a,PT b, PT c)
{
	glBegin(GL_TRIANGLES);
	{
...
void drawArraow()
{
	glPushMatrix();
	{
		...
		PT down_add = (arrowV_U - arrowV_D)*0.5;
		PT t_d = arrowV_D - down_add;

		PT a(arrowV_U.x,arrowV_U.y,0);
		PT b(t_d.x-2,arrowV_U.y-3,0);
		PT c(t_d.x+2,arrowV_U.y-3,0);
		drawTriange(a,b,c);
	}
	glPopMatrix();
...
{
	// // move forward
	to_add = (arrowV_U - arrowV_D)*0.001;
	...
	delY = arrowV_U.y - arrowV_D.y;
	delX = arrowV_U.x - arrowV_D.x;

	if(arrowV_U.x == arrowV_U.y &&  arrowV_D.x == arrowV_D.y && arrowV_U.x >= 40)
	{
		temp = arrowV_U;
		arrowV_U = arrowV_D;
		arrowV_D = temp;
	}
	else if(arrowV_U.x == arrowV_U.y &&  arrowV_D.x == arrowV_D.y && arrowV_U.x <= -40)
	{
		temp = arrowV_U;
		arrowV_U = arrowV_D;
		arrowV_D = temp;
	}
	else if(arrowV_U.x == arrowV_U.y &&  arrowV_D.x == arrowV_D.y && arrowV_U.y >= 40)
	{
		temp = arrowV_U;
		arrowV_U = arrowV_D;
		arrowV_D = temp;
	...
	else if(arrowV_U.x >= 40)
	{
		temp = arrowV_U;
		arrowV_U = arrowV_D + PT(0,2*delY,0);
		arrowV_D = temp;
	}
	else if(arrowV_U.x <= -40)
	{
	...
	else if(arrowV_U.y >= 40)
	{
		temp = arrowV_U;
		arrowV_U = arrowV_D + PT(2*delX,0,0);
		arrowV_D = temp;
	}
	else if(arrowV_U.y <= -40)
	{
